    ...
    <aside class="filter-sidebar">
        ...
        <div class="filter-section">
            ...
            <div class="price-range-container">
                <input type="range" min="0" max="1000000" step="100000" class="price-range" id="priceRange">
                    ...
                    <div class="card">
                        <a href="{{ route('product.details', ['id' => $product->id]) }}" class="product-card-link">
                            <div class="card-image">
                                ...
                                @endif
                                @else
                                <img class="default-image" src="{{ asset('image/picture_info.jpg') }}"
                ...
                <div class="card">
                    ...
                    <div class="card-info">
                        ...
                        <div class="card-buttons">
                            ...
                            <button type="submit" class="btn btn-cart add-to-cart" data-id="{{ $product->id }}"
                                data-size="M" data-quantity="1">
                                <i class="fas fa-cart-plus"></i>
                            </button>
                        </div>
                    </div>
